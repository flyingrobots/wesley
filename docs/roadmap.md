# Wesley V2 — Legacy Strategic Note

> Archived strategic note for Wesley V2.
> Active execution now lives in repo-visible METHOD surfaces: `docs/BEARING.md`,
> backlog lanes, design packets, and retros.
> This file preserves the older phase model and fixed-contract framing after
> its uncovered work was harvested into the backlog.
