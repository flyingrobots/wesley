...
Closed cycle packets live here. A cycle ends with a retro whether it succeeds,
partially lands, or fails honestly.

Each cycle should close with a directory like `docs/method/retro/<cycle>/`
containing:

- `<task>.md` for the cycle summary, outcome, drift, debt, and backlog
  maintenance notes
