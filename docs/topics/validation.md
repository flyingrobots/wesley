...
The gate runs formatting, clippy, docs checks, workspace tests, the lean-core
dependency check, and a native CLI smoke test. JavaScript dependency advisories are handled by Dependabot and
...
| `wesley-core` dependencies or features | `cargo xtask lean-core-check`                                                                     |
