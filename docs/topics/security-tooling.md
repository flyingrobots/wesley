...
| Rust product quality                      | `cargo xtask preflight` runs formatting, Clippy, workspace tests, docs checks, the lean-core dependency check, and a native CLI smoke test. | Active in the strict local gate.                                                         |
