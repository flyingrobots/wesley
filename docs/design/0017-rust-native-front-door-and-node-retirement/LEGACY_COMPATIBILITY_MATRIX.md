...
| ------ | ------------------------------- | -------------------------------------------------------------------------------------------------- |
| NR-076 | `packages/wesley-core/`         | Still imported by Holmes, host compatibility packages, legacy CLI compatibility code, and scripts. |
...
| `packages/wesley-generator-js/`         | NR-080 | Deleted | Retained TypeScript output belongs to Rust emitters; model scaffolding is retired; Zod is legacy CLI-local compatibility only. |
