...
| `pnpm run legacy-preflight`                                     | Direct JavaScript bridge behind `cargo xtask legacy-preflight`.                                                   | Keeps docs links, dependency boundaries, package-manager policy, package metadata, and license audit checks available for retained JavaScript tooling.                                                                 |
