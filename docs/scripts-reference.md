...
| `cargo xtask legacy-preflight`                                  | Historical Node package hygiene checks.                                                                           | Use only when changing legacy packages, package metadata, pnpm workspace files, or the legacy docs-command drift script.                                                                                               |
| `pnpm run legacy-preflight`                                     | Direct JavaScript bridge behind `cargo xtask legacy-preflight`.                                                   | Keeps the historical docs links, dependency boundaries, ESLint core purity, package metadata, and license audit checks available while Node packages are still present.                                                |
