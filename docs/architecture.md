...
runs: `preflight`, `docs-check`, `lean-core-check`, `release-prep-guard`,
`release-check`, `release-guard`, `release-autotag-plan`, `package-crates`, and
`publish-crates`. Run `cargo xtask help` for the list. [CI](ci.md) says which of
