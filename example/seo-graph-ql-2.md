Love it. Here’s how I’d write the GraphQL input (Wesley SDL) you’d check into schema.graphql. It’s declarative, consistent, and compiles cleanly to tables, views, RPCs, RLS, realtime, and audits.
