...
pub use domain::{
    ...
    LawAssurancePolicyProfile, LawAssurancePolicySchema, LawAssuranceProvenanceReport,
    LawAssuranceSuppressionMatch, LawAssuranceSuppressionRule, LawAssuranceSuppressionTarget,
    LawAssuranceSuppressionTargetKind, LawCapabilityClosure, LawCapabilityFootprint,
    LawCapabilityReport, LawCapabilitySlot, LawCoverageCategory, LawCoverageCategoryThreshold,
    LawCoverageGateDecision, LawCoverageGatePolicy, LawCoverageGateState, LawCoverageReport,
    ...
    LawEvidenceValidationStatus, LawFindingSeverity, LoadedArtifactMetadata,
    NormalizedContractBundleProvenance, NormalizedLawAssurancePolicy,
    ...
    WESLEY_LAW_IR_CANONICAL_JSON_CODEC, WESLEY_LEGACY_CAPABILITY_REPORT_API_VERSION,
};
pub use ports::{
