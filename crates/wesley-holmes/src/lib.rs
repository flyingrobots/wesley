...
pub use domain::{
    aggregate_law_assurance_assessment, bounded_finding_summary, default_severity_for_event,
    evaluate_bundle_traceability, evaluate_law_coverage_gates, law_assurance_provenance_report,
    map_semantic_finding_severities, matching_suppressions_for_finding,
    normalize_law_assurance_policy, parse_law_assurance_policy, percentage,
    semantic_change_findings_from_law_diff, sort_semantic_change_findings, ArtifactFamily,
    ArtifactRef, ArtifactRequirement, BoundedFindingSummary, BundleArtifactRef, BundleProvenance,
    BundleTraceabilityCheck, BundleTraceabilityGateDecision, BundleTraceabilityGateState,
    ContractBundleManifest, CoverageAbsentCategoryBehavior, CoverageUnavailableBehavior,
    HolmesDiagnostic, HolmesDiagnosticCode, HolmesLawEvidenceBundle, HolmesResult, HolmesSeverity,
    LawAssuranceArtifactProvenance, LawAssuranceAssessmentOutcome, LawAssuranceAssessmentSummary,
    LawAssuranceCoverageThresholdPolicy, LawAssurancePolicyProfile, LawAssurancePolicySchema,
    LawAssuranceProvenanceReport, LawAssuranceSuppressionMatch, LawAssuranceSuppressionRule,
    LawAssuranceSuppressionTarget, LawAssuranceSuppressionTargetKind, LawCapabilityClosure,
    LawCapabilityFootprint, LawCapabilityReport, LawCapabilitySlot, LawCoverageCategory,
    LawCoverageCategoryThreshold, LawCoverageGateDecision, LawCoverageGatePolicy,
    LawCoverageGateState, LawCoverageReport, LawDiffEvent, LawDiffEventKind, LawDiffFieldChange,
    ...
    NormalizedLawDiffEvent, ParsedSchemaVersion, SemanticChangeFinding, VersionCheck,
    VersionRegistry, VersionRequirement, HOLMES_LAW_ASSURANCE_POLICY_API_VERSION,
