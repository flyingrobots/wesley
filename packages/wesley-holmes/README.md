...
- **Product profiles** – Product packages such as `@wesley/continuum` may define domain-specific Holmes/Watson/Moriarty behavior profiles while `@wesley/holmes` remains the shared execution engine.
