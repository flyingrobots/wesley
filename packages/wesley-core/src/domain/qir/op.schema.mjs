/**
 * JSON Schema (as JS object) for Ops DSL (*.op.json)
 * Kept in core to share across hosts. Imported by CLI via ESM.
 */
  ...
  $defs: {
    ...
    filter: {
      ...
      properties: {
        ...
        // exactly one of param or value for comparison ops; none for isNull/isNotNull
    ...
    list: {
      ...
      required: ['table'],
      properties: {
        alias: { type: 'string', minLength: 1 }, // json field alias
        table: { type: 'string', minLength: 1 },
