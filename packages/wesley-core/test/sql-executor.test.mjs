...
import {
  ...
  SQLOperation,
  SQLExecutorStarted,
  _SQLOperationStarted,
  _SQLOperationCompleted,
  _SQLExecutorError,
  _SQLTransactionStarted,
  _SQLTransactionCommitted,
  _SQLAdvisoryLockAcquired
...
describe('SQLExecutor', () => {
  ...
  test('should handle operation failures', async () => {
    ...
    await assert.rejects(
      async () => executor.executeOperation(operation),
      /SQL syntax error/
    );
