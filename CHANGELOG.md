...
- **F:** `sanitizeGraphQL()` in Node host simplified to BOM-only stripping, aligning with browser runtime — null bytes now fail visibly at parse time instead of being silently stripped
