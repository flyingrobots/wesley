...
| `measure-ir-performance.mjs` | Measures Rust CLI `schema lower` wall-clock samples with bounded Alfred process calls, without setting a threshold.             | `pnpm perf:ir -- --markdown --output out/rust-ir-performance-baseline.md`                                                             |
