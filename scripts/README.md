...
| `check-package-manager-policy.mjs` | Verifies the pnpm packageManager pin and single-lockfile policy.                                                                  | `node scripts/check-package-manager-policy.mjs`                                                                                       |
...
| `setup-bats-plugins.sh`            | Verifies pinned Bats testing plugins vendored under `test/vendor/bats-plugins`.                                                   | `bash scripts/setup-bats-plugins.sh`                                                                                                  |
