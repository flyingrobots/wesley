...
| `measure-ir-performance.mjs` | Measures Rust CLI `schema lower` wall-clock samples over the explicit Rust IR fixture corpus without setting a threshold.      | `pnpm perf:ir -- --markdown --output out/rust-ir-performance-baseline.md`                                                             |
